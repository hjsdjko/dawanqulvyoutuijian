...
public class JingdianOrderEntity<T> implements Serializable {
     ...
     * 预定人数
     */
    @TableField(value = "jingdian_order_number")

    private Integer jingdianOrderNumber;
	 ...
	 * 设置：预定人数
	 */
    public Integer getJingdianOrderNumber() {
        return jingdianOrderNumber;
    }
    ...
    public void setJingdianOrderNumber(Integer jingdianOrderNumber) {
        this.jingdianOrderNumber = jingdianOrderNumber;
    }
    /**
	 * 设置：创建时间
	 */
    ...
    public String toString() {
        return "JingdianOrder{" +
            ...
            ", jingdianOrderNumber=" + jingdianOrderNumber +
